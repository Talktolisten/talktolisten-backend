...
voice1 = Voice(
    voice_id=101,
    voice_name="Mia",
    voice_description="A skilled healer and herbalist, Sister Anya resides in a remote forest monastery. Her deep connection with nature allows her to create powerful healing potions and remedies using the forest's plants",
    voice_endpoint="https://sister-anya.herokuapp.com/",
...
voice2 = Voice(
    voice_id=102,
    voice_name="Eamon Shadowreaper",
    voice_description="A spectral assassin with a thirst for vengeance, Eamon Shadowreaper uses his ghostly abilities to eliminate those who have wronged him. His stealth and precision make him a deadly foe, feared by both the living and the dead",
    voice_endpoint="https://eamon-shadowreaper.herokuapp.com/",
...
db.add(user1)
db.add(user2)
db.add(bot1, bot2, bot3)
db.add(voice1, voice2)
db.add(chat1, chat12, chat3)
db.add(message1, message12, message13, message14)
db.add(message2, message21)
db.add(message3, message31)
